...
import AgentCLISwitcher from '@/components/chat/AgentCLISwitcher';
        ...
        >
          ...
          {isWelcome ? (
            ...
            <div className="flex items-center gap-2 px-5 pb-3.5">
              ...
              {/* Agent CLI Switcher — choose between Abu and external CLI agents */}
              <AgentCLISwitcher />
            ...
            <div className="flex items-center justify-between px-4 pb-2.5 pt-0.5">
              ...
              <div className="flex items-center gap-0.5">
                ...
                {/* Agent CLI Switcher — external CLI agents */}
                <AgentCLISwitcher />
