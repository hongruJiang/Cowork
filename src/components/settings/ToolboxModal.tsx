...
import { Sparkles, Bot, Server, Terminal } from 'lucide-react';
...
import AgentCLISection from '../customize/AgentCLISection';
...
export default function ToolboxView() {
  ...
  const handleAICreate = () => {
    if (activeToolboxTab === 'agent-cli') return; // read-only tab
  ...
  const navItems: { id: ToolboxTab; label: string; icon: typeof Sparkles }[] = [
    ...
    { id: 'agent-cli', label: 'Agent CLI', icon: Terminal },
  ];
